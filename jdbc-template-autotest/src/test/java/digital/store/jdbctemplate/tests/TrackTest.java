...
@Owner("ObvintcevAE")
@DisplayName("Track: JdbcTemplate тесты")
...
public class TrackTest extends BaseTest {
    ...
    void testA_insertAndSelect() {
        // шаг 5: создаём трек, связывая все три зависимости
