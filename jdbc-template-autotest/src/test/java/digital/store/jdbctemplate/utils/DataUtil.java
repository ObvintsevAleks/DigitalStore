...
public class DataUtil {
    ...
    public static GenreDto getGenreDto() {
        return GenreDto.builder()
                ...
                .name(Faker.instance().music().genre() + "_" + UUID.randomUUID().toString().replace("-", "").substring(0, 8))
    ...
    public static MediaTypeDto getMediaTypeDto() {
        return MediaTypeDto.builder()
                ...
                .name(Faker.instance().company().buzzword() + "_" + UUID.randomUUID().toString().replace("-", "").substring(0, 8))
