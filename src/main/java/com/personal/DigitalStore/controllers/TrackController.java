...
import com.personal.DigitalStore.services.TrackService;
...
public class TrackController {
    ...
    @ApiUpdate
    @Operation(summary = "Обновить аудиозапись")
    @ApiResponse(responseCode = "200", description = "В случае успешного выполнения",
            content = @Content(schema = @Schema(implementation = TrackDTO.class)))
    @PutMapping
    ...
    @ApiDelete
    @Operation(summary = "Удалить аудиозапись")
    @DeleteMapping("/{id}")
    ...
    @ApiCreate
    @Operation(summary = "Создать аудиозапись")
    ...
    @ApiGet
    @Operation(summary = "Получить все аудиозаписи по идентификатору альбома")
    ...
    @ApiGet
    @Operation(summary = "Получить все аудиозаписи по идентификатору жанра")
    ...
    @ApiGet
    @Operation(summary = "Получить все аудиозаписи по идентификатору медиа-типа")
    ...
    @ApiGet
    @Operation(summary = "Получить все аудиозаписи по идентификатору артиста")
    ...
    @ApiGet
    @Operation(summary = "Получить все аудиозаписи по псевдониму артиста")
