...
import com.personal.DigitalStore.services.AlbumService;
...
public class AlbumController {
    ...
    @ApiGet
    @Operation(summary = "Получить альбом по идентификатору")
    ...
    @ApiGet
    @Operation(summary = "Получить список альбомов по идентификатору артиста")
    @ApiResponse(responseCode = "200", description = "В случае успешного выполнения",
    ...
    @ApiGet
    @Operation(summary = "Получить список альбомов по заголовку")
    @ApiResponse(responseCode = "200", description = "В случае успешного выполнения",
            content = @Content(schema = @Schema(allOf = AlbumDTO.class)))
    ...
    @ApiGet
    @Operation(summary = "Получить список альбомов по псевдониму артиста")
    @ApiResponse(responseCode = "200", description = "В случае успешного выполнения",
            content = @Content(schema = @Schema(allOf = AlbumDTO.class)))
