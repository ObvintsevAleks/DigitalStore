...
public class CustomerController {
    ...
    @ApiGet
    @Operation(summary = "Получить клиента по идентификатору", description = "Получить клиента по идентификатору", tags = {"customer-controller"})
    ...
    @ApiUpdate
    @Operation(summary = "Обновить клиента", description = "Обновить клиента", tags = {"customer-controller"})
    @ApiResponse(responseCode = "200", description = "В случае успешного выполнения",
            content = @Content(schema = @Schema(implementation = CustomerDTO.class)))
    @PutMapping
    ...
    @ApiDelete
    @Operation(summary = "Удалить клиента", description = "Удалить клиента", tags = {"customer-controller"})
    @DeleteMapping("/{id}")
    ...
    @ApiCreate
    @Operation(summary = "Создать клиента", description = "Создать клиента", tags = {"customer-controller"})
    ...
    @ApiGet
    @Operation(summary = "Получить список клиентов по имени", description = "Получить список клиентов по имени", tags = {"customer-controller"})
    ...
    @ApiGet
    @Operation(summary = "Получить список клиентов по фамилии", description = "Получить список клиентов по фамилии", tags = {"customer-controller"})
