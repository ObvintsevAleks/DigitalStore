...
public class GenreController {
    ...
    @ApiGet
    @Operation(summary = "Получить все жанры", description = "Получить все жанры", tags = {"genre-controller"})
    @GetMapping("/all")
    ...
    @ApiGet
    @Operation(summary = "Получить жанр по идентификатору", description = "Получить жанр по идентификатору", tags = {"genre-controller"})
    ...
    @ApiCreate
    @Operation(summary = "Создать жанр", description = "Создать жанр", tags = {"genre-controller"})
    ...
    @ApiUpdate
    @Operation(summary = "Обновить жанр", description = "Обновить жанр", tags = {"genre-controller"})
    @ApiResponse(responseCode = "200", description = "В случае успешного выполнения",
            content = @Content(schema = @Schema(implementation = GenreDTO.class)))
    @PutMapping
    ...
    @ApiDelete
    @Operation(summary = "Удалить жанр", description = "Удалить жанр", tags = {"genre-controller"})
    @DeleteMapping("/{id}")
