...
@ApiResponses({
        @ApiResponse(responseCode = "204", description  = "В случае успешного удаления", content = @Content),
        @ApiResponse(responseCode = "400", description  = "В случае, если сущность используется и не может быть удалена", content = @Content),
